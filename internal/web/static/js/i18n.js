...
const messages = {
  en: {
    ...
    'image.pulling':         'Pulling...',
    'image.pullLog':         'Pull Log',
    'image.pullSuccess':     'Image pulled successfully',
    'image.pullFailed':      'Image pull failed',
    'image.pullHint':        'Recommended — pulls pre-built image from registry (~1.4 GB)',
  ...
  zh: {
    ...
    'image.pulling':         '拉取中...',
    'image.pullLog':         '拉取日志',
    'image.pullSuccess':     '镜像拉取成功',
    'image.pullFailed':      '镜像拉取失败',
    'image.pullHint':        '推荐 — 从镜像仓库拉取预构建镜像（约 1.4 GB）',
    'image.build':           '构建镜像',
    'image.building':        '构建中...',
    'image.buildLog':        '构建日志',
